...
import 'package:icheck_android/leaves_screen/leave_approval_screen.dart';
import 'package:icheck_android/leaves_screen/leaves.dart';
...
class _LeaveRequestScreenTwoState extends State<LeaveRequestScreenTwo> {
  ...
  Future<void> getUserLeaveRequests() async {
    ...
    userObj = convert.jsonDecode(userData!);
    ...
    if (response.statusCode == 200 &&
        ...
        response2.body != null) {
      setState(() {
        individualReqLeaveList = convert.jsonDecode(response.body);
        groupReqLeaveList = convert.jsonDecode(response2.body);
      });
