...
import 'package:icheck_android/leaves_screen/full_screen_view_attachmanet.dart';
import 'package:icheck_android/leaves_screen/view_leave.dart';
    ...
    if (choice == _menuOptions[0]) {
      Navigator.push(
        ...
        MaterialPageRoute(builder: (context) {
          return HelpTwo(user: widget.user, index3: widget.index3);
        }),
      );
      ...
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) {
          return AboutUs(user: widget.user, index3: widget.index3);
        }),
      );
      ...
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) {
          return ContactUs(user: widget.user, index3: widget.index3);
        }),
      );
      ...
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) {
          return TermsAndConditions(user: widget.user, index3: widget.index3);
        }),
      );
